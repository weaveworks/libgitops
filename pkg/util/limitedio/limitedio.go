...
// TODO: This code is implicitely tested from pkg/frame, but in the future,
// make an unit test for this
...
// Infinite represents no upper bound
const Infinite Limit = -1

// Limit describes a numeric upper bound
type Limit int64
