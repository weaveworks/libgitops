...
type RawStorage interface {
	...
	ContentType(key ObjectKey) stream.ContentType
...
func NewGenericRawStorage(dir string, gv schema.GroupVersion, ct stream.ContentType) RawStorage {
...
func (r *GenericRawStorage) ContentType(_ ObjectKey) stream.ContentType {
	return r.ct
}
